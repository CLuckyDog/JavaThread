...
public class URLTools{
    ...
    public static void main(String[] args) {
        ...
        if(URLTools.isUtf8Url(url)){
            System.out.println(URLTools.Utf8URLdecode(url));
        }

        url = "http%253A%252F%252F222.217.76.249%253A10398%252FnotifyV2.php";
        System.out.println(URLTools.isUtf8Url(url));
